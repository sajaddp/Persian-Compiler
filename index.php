    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 sidebar">
            <div class="panel panel-default">
                <div class="panel-heading backcolor" data-toggle="collapse" data-target="#collapse_1" aria-expanded="false"
                     aria-controls="collapse_1"><span class="caret"></span> راهنما
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading backcolor" data-toggle="collapse" data-target="#collapse_2" aria-expanded="false"
                     aria-controls="collapse_2"><span class="caret"></span> نتیجه
                </div>
        ...
        <div class="col-sm-6 col-md-6">
            ...
            <form class="form-horizontal ajax-form rtl" action="run.php">
                <fieldset>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <textarea class="form-control" id="textarea" name="dic"
                                      placeholder="در صورتی که تمایل دارید لغاتی را به برنامه اضافه کنید در این کادر وارد نمایید (لغات را با فاصله از هم جدا کنید)"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
